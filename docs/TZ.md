...
MCP-сервер (`waymark-hub`) с общим SQLite-хранилищем. Все поверхности подключаются к нему и читают/пишут один и тот же контекст.
...
└──────┬────────┴────────┬─────────┴────────┬─────────┘
       ...
       └────────────────┬┘─────────────────┘
                        ▼
              ┌─────────────────┐
              │ waymark-hub  │  Node.js 22 / TypeScript
